...
#### 2.1.2 問題分類
- **難易度**: 2級 / 3級
- **カテゴリ**: 歴史、史跡、神社、寺院、建築、庭園、美術、伝統工芸、伝統文化、花街、祭と行事、京料理、京菓子、ならわし、ことばと伝説、地名、自然、観光学 等、京都に関すること全般
- **回答形式**: 4択（選択肢4つから1つ選択）
  ...
  "questions": [
    {
      ...
      "level": "3級",
      "category": "寺社・仏閣",
      "question": "清水寺の本堂から突き出した舞台の高さは約何メートルか？",
      "options": [
        "約8メートル",
        "約13メートル",
        "約18メートル",
      ...
      "correctAnswer": 1,
      "explanation": "清水の舞台は地上から約13メートルの高さがあり、釘を1本も使わない懸造（かけづくり）という伝統工法で建てられています。"
    }
  ]
}
```
